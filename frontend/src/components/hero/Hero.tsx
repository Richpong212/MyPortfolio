    ...
    return (
        <div className="relative w-full min-h-screen overflow-hidden">
            ...
            <div className='relative z-10 flex items-center'>
                <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div className="flex-1 space-y-6 text-center md:text-left pt-20 ">
                        ...
                        {/* Glowing Mouse Icon */}
                        <div className="absolute -bottom-60 transform -translate-x-1/2 animate-blink hover:drop-shadow-[0_0_8px_#ec4899]">
                            <img
                                src="/icons/mouse.svg"
                                alt="Scroll Mouse"
                                className="w-14 h-14"
            ...
            <div className="absolute top-0 left-0 w-full h-full">
                <Canvas className="absolute top-0 left-0 w-full h-full z-0" camera={{ position: [0, 0, 8], fov: 50 }}>
